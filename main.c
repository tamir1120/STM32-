...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  //--------------------------Define the Timers------------------------
  HAL_TIM_Base_Start_IT(&htim2); //Start timer interrupt 2
  HAL_TIM_Base_Start_IT(&htim3); //Start timer interrupt 3
  HAL_TIM_Base_Start_IT(&htim4); //Start timer interrupt 4

  //--------------------------Define the Ultra-Sonic----------------------------
